...
public class SendEmailSMTP {
    ...
    public static void sendOTP(String emailTo, String otp) {
        String username = "dominhquan15623@gmail.com";
        String password = "xmbo tkvp wsss vdoo";
...
"                    <a href=\"#\" style=\"font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600\">OTP by Quản lý siêu thị mini</a>" +
"                </div>" +
"                <p style=\"font-size:1.1em\">Hi,</p>" +
"                <p>Vui lòng không chia sẻ mã OTP với bất kỳ ai!! Nhập mã OTP dưới đây để hoàn tất việc xác minh. OTP có hiệu lực trong 5 phút.</p>" +
