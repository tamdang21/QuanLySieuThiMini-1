...
public class KhachHangDialog extends JDialog implements MouseListener {
    ...
    public KhachHangDialog(KhachHang jpKH, JFrame owner, String title, boolean modal, String type, KhachHangThanThietDTO kh) {
        super(owner, title, modal);
        this.kh=kh;
        maKH = new JTextField("");
...
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == btnThem && Validation()) {
                int id=KhachHangThanThietDAO.getInstance().getAutoIncrement();
                jpKH.khachhangBUS.add(new KhachHangThanThietDTO(id, tenKH.getText(),sdtKH.getText(), diachiKH.getText(), 0, 0));
            ...
            jpKH.khachhangBUS.update(new KhachHangThanThietDTO(kh.getMaKH(), tenKH.getText(), sdtKH.getText(), diachiKH.getText(), 0, 0));
            jpKH.loadDataTable(jpKH.listkh);
            dispose();
        }
    }
