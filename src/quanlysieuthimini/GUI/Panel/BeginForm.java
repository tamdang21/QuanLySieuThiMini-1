...
public class BeginForm extends JPanel {
    ...
    PanelShadow content[];
        String[][] getSt = {
        {"Tính chính xác", "tinhchinhxac_128px.svg", "<html>Mã vạch là một số duy nhất được <br>gán cho từng sản phầm trong siêu thị,<br> do đó hệ thống quản lý sản phẩm<br> theo mã vạch sẽ đảm bảo tính <br>chính xác và độ tin cậy cao.</html>"},
        {"Tính bảo mật", "tinhbaomat_128px.svg", "<html>Ngăn chặn việc sử dụng các sản phẩm<br> giả mạo hoặc bị đánh cắp.<br> Điều này giúp tăng tính bảo mật cho <br>các hoạt động quản lý sản phẩm.</html>"},
        {"Tính hiệu quả", "tinhhieuqua_128px.svg", "<html>Dễ dàng xác định được thông tin <br>về từng sản phầm trong siêu thị một cách <br>nhanh chóng và chính xác, giúp <br>cho việc quản lý bán hàng được <br>thực hiện một cách hiệu quả hơn.</html>"},
    };
