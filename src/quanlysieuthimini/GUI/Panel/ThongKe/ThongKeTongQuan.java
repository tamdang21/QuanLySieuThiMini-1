package quanlysieuthimini.GUI.Panel.ThongKe;

import quanlysieuthimini.BUS.ThongKeBUS;
...
import quanlysieuthimini.GUI.Component.Chart.CurveChart.CurveChart;
import quanlysieuthimini.GUI.Component.Chart.CurveChart.ModelChart2;
...
public class ThongKeTongQuan extends JPanel {
    ...
    String[][] getSt = {
        {"Sản phẩm hiện có trong kho", "productt.svg", Integer.toString(SanPhamDAO.getInstance().getAll().size())},
        {"Khách từ trước đến nay", "stafff.svg", Integer.toString(KhachHangThanThietDAO.getInstance().getAll().size())},
