...
public class NhanVienDialog extends JDialog {
    ...
    public NhanVienDialog(NhanVienBUS nv, JFrame owner, boolean modal, String title, String type, NhanVienDTO nhanVien) {
        super(owner, title, modal);
        this.nv = nv;
                ...
                try {
                    if (ValidationInput()) {
                        ...
                        try {
                            ...
                            NhanVienDTO nV = new NhanVienDTO(manv, txtName, "", txtSdt, txtEmail, sqlDate, txt_gender, 0.2, "" , 1);
                ...
                try {
                    if (ValidationInput()) {
                        try {
                            ...
                            Date birthDay = jcBd.getDate();
                            java.sql.Date sqlDate = new java.sql.Date(birthDay.getTime());
                            NhanVienDTO nV = new NhanVienDTO(nhanVien.getMaNV(), txtName, "", txtSdt, txtEmail, sqlDate, txt_gender, 0.2, "" , 1);
