...
public class TaiKhoanDialog extends JDialog {
    ...
    public TaiKhoanDialog(TaiKhoan taiKhoan, JFrame owner, String title, boolean modal, String type, TaiKhoanDTO tk) {
        ...
        this.taiKhoan = taiKhoan;
        username.setText(tk.getTenTK());
        password.setPass(tk.getMatKhau());
        maQuyen.setSelectedItem(QuyenDAO.getInstance().getById(tk.getMaQuyen()).getTenQuyen());
    ...
    public void init(String title, String type) {
        ...
        maQuyen = new SelectForm("Nhóm quyền", getQuyen());
            ...
            public void actionPerformed(ActionEvent e) {
                if (validateInput()) {
                    ...
                    for (TaiKhoanDTO i : listTK) {
                        if (i.getTenTK().equals(username.getText())) {
                            check++;
                            break;
                        }
                    }
...
//                password.setEditable(false);
    ...
    public String[] getQuyen() {
        String[] listQuyen = new String[listNq.size()];
        for (int i = 0; i < listNq.size(); i++) {
            listQuyen[i] = listNq.get(i).getTenQuyen();
        }
        return listQuyen;
    }
