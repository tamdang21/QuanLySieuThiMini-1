        ...
        if (jbr[0].isSelected()) {
            if (e.getSource() == save) {
                if (Validation.isEmpty(phone.getText()) || phone.getText().length() != 10) {
                    ...
                    NhanVienDTO nvdto = new NhanVienDTO(nv.getMaNV(), nv.getTenNV(), nv.getDiaChi(), sdt, nv.getEmail(), nv.getNgaySinh(), nv.getGioiTinh(), nv.getLuong(), nv.getHinhAnh(), nv.getTrangThai());
        ...
        if (jbr[1].isSelected()) {
            if (e.getSource() == save) {
                if (Validation.isEmpty(email.getText()) || !Validation.isEmail(email.getText())) {
                    ...
                    NhanVienDTO nvdto = new NhanVienDTO(nv.getMaNV(), nv.getTenNV(), nv.getDiaChi(), nv.getSDT(), emailString, nv.getNgaySinh(), nv.getGioiTinh(), nv.getLuong(), nv.getHinhAnh(), nv.getTrangThai());
                    NhanVienDAO.getInstance().update(nvdto);
                    JOptionPane.showMessageDialog(this, "Cập nhật thành công");
