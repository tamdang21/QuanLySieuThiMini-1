...
public class ListNhanVienPCC extends JDialog implements MouseListener {

    private PhanCongCa guiPCC;
    ...
    public ListNhanVienPCC(PhanCongCa pcc, JFrame owner, String title, boolean modal){
        ...
        buttonAdd.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                "Vui lòng chọn nhân viên!:)", "Thông báo", JOptionPane.DEFAULT_OPTION);
                    ...
                    dispose();
                    //TaiKhoanDialog tkd = new TaiKhoanDialog(guiPCC, guiTaiKhoan.owner, "Thêm tài khoản", true, "create", listnv.get(getRow()).getMaNV());
                    new ListCaLamViecPCC(guiPCC, guiPCC.owner, "Thêm ca làm", true, "create", listnv.get(getRow()).getMaNV());
                }
            }
    ...
    public void loadDataTalbe(ArrayList<NhanVienDTO> list) {
        listnv = list;
        tblModel.setRowCount(0);
        for (NhanVienDTO nhanVien : listnv) {
            tblModel.addRow(new Object[]{
                nhanVien.getMaNV(),nhanVien.getTenNV(),nhanVien.getGioiTinh()==1?"Nam":"Nữ",nhanVien.getNgaySinh(),nhanVien.getSDT(),nhanVien.getEmail()
            });
        }
    }
